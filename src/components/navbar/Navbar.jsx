...
function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <a href="#" className={`flex items-center space-x-3 rtl:space-x-reverse ${isMenuOpen ? 'text-3xl' : 'text-5xl'}`}>
          {/* Decrease text size when the menu is open */}
          <span className="self-center lg:text-2xl md:text-5xl lg:text-5xl  font-semibold whitespace-nowrap dark:text-white">
            Cypher
          </span>
        </a>
        ...
        onClick={toggleMenu}
        type="button"
        className="inline-flex items-right p-2 w-10 h-10 justify-right text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
