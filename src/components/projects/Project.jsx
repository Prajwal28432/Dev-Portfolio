...
function Project() {
  const projects = [
    ...
    },
    {
      name: 'GymFit(RestApi)',
      imageUrl: gymfit,
      description: "It is Api for  a fitness method and competitive sport that combines high-intensity workouts with elements from several sports (olympic weightlifting, gymnastics, and others).",
    },
    // {
    //   name: "EcomX",
    //   imageUrl: ,
